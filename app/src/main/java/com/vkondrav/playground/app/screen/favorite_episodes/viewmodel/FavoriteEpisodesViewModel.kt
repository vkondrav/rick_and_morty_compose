package com.vkondrav.playground.app.screen.favorite_episodes.viewmodel
...
import com.vkondrav.playground.app.screen.favorite_episodes.usecase.FetchFavoriteEpisodesUseCase
...
class FavoriteEpisodesViewModel(
    private val fetchFavoriteEpisodesUseCase: FetchFavoriteEpisodesUseCase,
    ...
    override val items: StateFlow<List<ComposableItem>>
        get() = fetchFavoriteEpisodesUseCase().getOrElse {
